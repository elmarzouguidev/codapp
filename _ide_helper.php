...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Spatie\CollectionMacros\Macros\FirstOrFail::__invoke()
         * @static 
         */ 
     ...
     */ 
         ...
         *
         * @param \Rap2hpoutre\FastExcel\Collection $data
         * @return \FastExcel 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function configureCsv($delimiter = ',', $enclosure = '"', $eol = '
', $encoding = 'UTF-8', $bom = false)
        {
                        /** @var \Rap2hpoutre\FastExcel\FastExcel $instance */
                        return $instance->configureCsv($delimiter, $enclosure, $eol, $encoding, $bom);
        }
                    /**
         ...
         * @return \Rap2hpoutre\FastExcel\Collection 
         * @static 
         */ 
