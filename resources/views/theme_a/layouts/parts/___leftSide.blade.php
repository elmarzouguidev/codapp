<div id="left-sidebar" class="sidebar">
    ...
    <nav id="left-sidebar-nav" class="sidebar-nav">
        <ul class="metismenu">
            <li class="{{request()->routeIs('homee') ? 'active':''}}"><a href="{{route('homee')}}"><i class="fa fa-gear"></i><span>Home</span></a></li>
            <li class="{{request()->routeIs('aboutee') ? 'active':''}}"><a href="{{route('aboutee')}}"><i class="fa fa-gear"></i><span>About</span></a></li>
        </ul>
    </nav>
</div>
