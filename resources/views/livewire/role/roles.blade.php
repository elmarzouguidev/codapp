                        ...
                        <tbody>
                            ...
                            @foreach($roles as $role)
                                <tr class="">
                                    ...
                                    <td>
                                        <div><a href="javascript:void(0);">{{$role->name}}</a></div>
                                        <div class="text-muted">{{$role->guard_name}}</div>
                                    </td>
                                    {{--<td class="hidden-xs">
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a  wire:click="editRole({{$role->id}})" class="btn btn-sm btn-link" href="javascript:void(0)" data-toggle="tooltip" title="Edite"><i class="fa fa-edit"></i></a>
                                        <a  wire:click="deleteRole({{$role->id}})" class="btn btn-sm btn-link hidden-xs js-sweetalert" data-type="confirm" href="javascript:void(0)" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
