...
Route::get('install/pre-installation',[InstallController::class,'preInstallation'])->name('install.pre_installation');
Route::get('install/configuration', [InstallController::class,'getConfiguration'])->name('install.configuration.show');
